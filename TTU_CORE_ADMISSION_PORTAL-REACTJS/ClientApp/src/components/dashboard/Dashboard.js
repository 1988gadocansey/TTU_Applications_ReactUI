...
import {getProgrammes} from "../../actions/programmes/ProgrammeActions";
 const Dashboard = () => {
    ...
    useEffect(getProgrammes(dispatch),[])
     ...
     const pictureUploaded = (user?.pictureUploaded === 1) ? "Uploaded"/* <img style={{width:'66px',height:'93px'}}
                                                                 src="https://photos.ttuportal.com/public/albums/thumbnails/07147055.jpg"
                                                                 
                                                                 className="md-user-image"
                                                                 asp-append-version="true" alt="your passport photo"/>*/ : "Pending";
                        ...
                        <div className="ant-card-body">
                            <div className="ant-row ant-row-center ant-row-middle"
                                ...
                                <div className="ant-col" style={{paddingLeft: '10px', paddingRight: '10px'}}><h6
                                    className="dashIconTitsle">{admissionStatus}</h6><h6 className="dashIconText">Admission Status</h6></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="ant-card ant-card-bordered overviewCard1">
                        <div className="ant-card-body">
                            <div className="ant-row ant-row-center ant-row-middle"
                                ...
                                <div className="ant-col" style={{paddingLeft: '10px', paddingRight: '10px'}}><h6
                                    className="dashIconTitsle">{formCompleted}</h6><h6 className="dashIconText">Form Completed?</h6></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="ant-card ant-card-bordered overviewCard1">
                        <div className="ant-card-body">
                            <div className="ant-row ant-row-center ant-row-middle"
                                ...
                                <div className="ant-col" style={{paddingLeft: '10px', paddingRight: '10px'}}><h6
                                    className="dashIconTitsle">{user?.formNo}</h6><h6 className="dashIconText">Form No</h6></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="ant-card-body">
                            <div className="ant-row ant-row-center ant-row-middle"
                                ...
                                <div className="ant-col" style={{paddingLeft: '10px', paddingRight: '10px'}}><span
                                    ...
                                    <svg
                                    viewBox="64 64 896 896" focusable="false" data-icon="user" width="1em" height="1em"
                                ...
                                <div className="ant-col" style={{paddingLeft: '10px', paddingRight: '10px'}}><h6
                                    className="dashIconTitsle">{pictureUploaded}</h6><h6 className="dashIconText">Picture Status</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="ant-col ant-col-24">
                    <div className="ant-card">
                        <div className="ant-card-body">
                            ...
                            <center><p><strong>For more information call 0508333992 / 0553777777 / 0243348522 /
                                0508335033</strong></p></center>
                            &nbsp;
